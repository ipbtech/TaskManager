...
namespace TaskManager.Api.Migrations
{
    ...
    [Migration("20240726234340_SetNullDeleteBehaviourForAdminId")]
    partial class SetNullDeleteBehaviourForAdminId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "admin",
                            Password = "qwerty",
                            RegistrDate = new DateTime(2024, 7, 27, 2, 43, 38, 17, DateTimeKind.Local).AddTicks(3304),
                            Role = 3
                        });
                });
            ...
            modelBuilder.Entity("TaskManager.DAL.Models.Desk", b =>
                {
                    b.HasOne("TaskManager.DAL.Models.User", "DeskOwner")
                        .WithMany("Desks")
